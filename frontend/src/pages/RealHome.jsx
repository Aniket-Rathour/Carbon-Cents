...
function RealHome() {
    ...
    return (
        <div className="min-h-screen bg-[radial-gradient(ellipse_at_center,#4f4f51,#000000)]">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-2">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="w-28 h-12 border text-white border-white rounded-full mt-2 flex items-center justify-start pl-2 text-black text-base font-light"> {/* Changed justify-end pr-2 to justify-start pl-2 */}
                                    10 Ton
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex space-x-8 self-end">
                        <div className="flex items-end">
                            <div className="flex flex-col items-center mr-1">
                                <div className="bg-gray-300 backdrop-blur-sm rounded-xl p-1">
                                    <Users size={20} />
                                </div>
                                <p className="text-xs text-white mt-1">Coin Cost</p>
                            </div>
                        ...
                        <div className="flex items-end">
                            <div className="flex flex-col items-center mr-1">
                                ...
                                <p className="text-xs text-white mt-1 ">Solana cost</p>
                            </div>
                    ...
                    <div className="flex-1 flex flex-col rounded-4xl space-y-1 h-full">
                        ...
                        <div className="flex-1 rounded-4xl bg-cover bg-center p-4 relative overflow-hidden" style={{ backgroundImage: `url('https://i.pinimg.com/736x/39/6d/f5/396df568a4325fe46c4a4801e198e7ef.jpg')` }}>
                            ...
                            <div className="relative z-10 text-white h-full flex flex-row justify-between items-end p-1">
                                <div>
                                    <p className="text-2xl font-light">Aniket </p>
